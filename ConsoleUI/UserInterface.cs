...
namespace ConsoleUI
{
   ...
   @"Please choose from the following options (1-9):
        ...
        private static void addGasToVehicle()
        {
            ...
            Console.WriteLine("Please enter licence number: ");
            string license = Console.ReadLine();
            GasolinePowerSource.eGasType gasType = (GasolinePowerSource.eGasType)getUserChoiceFromEnumValues(typeof(GasolinePowerSource.eGasType));
        ...
        private static Vehicle getVehicleFromUser()
        {
            ...
            Vehicle createdVehicleData = null;
            ...
            switch (typeOfVehicleToAdd)
            {
                case Vehicle.eTypeOfVehicle.GasCar:
                    userEnteredParameters = getParametersFromUser(GasolinePrivateCar.GetRequiredParameters());
                    createdVehicleData = new GasolinePrivateCar(
                                                       (string)userEnteredParameters[0],
                                                       (string)userEnteredParameters[1],
                    (string)userEnteredParameters[2],
                                                       (PrivateCar.eCarColor)userEnteredParameters[3],
                                                       (PrivateCar.eNumOfDoors)userEnteredParameters[4]);
                    break;
                case Vehicle.eTypeOfVehicle.ElectricCar:
                    userEnteredParameters = getParametersFromUser(ElectricPrivateCar.GetRequiredParameters());
                    createdVehicleData = new ElectricPrivateCar(
                                                            (string)userEnteredParameters[0],
                                                            (string)userEnteredParameters[1],
                                                            (string)userEnteredParameters[2],
                                                            (PrivateCar.eCarColor)userEnteredParameters[3],
                ...
                case Vehicle.eTypeOfVehicle.ElectricMotorcycle:
                    userEnteredParameters = getParametersFromUser(ElectricMotorcycle.GetRequiredParameters());
                    createdVehicleData = new ElectricMotorcycle(
                                                                   (string)userEnteredParameters[0],
                                                                   (string)userEnteredParameters[1],
                                                                   (string)userEnteredParameters[2],
                ...
                case Vehicle.eTypeOfVehicle.GasMotorcycle:
                    userEnteredParameters = getParametersFromUser(GasolineMotorcycle.GetRequiredParameters());
                    createdVehicleData = new GasolineMotorcycle(
                                                              (string)userEnteredParameters[0],
                                                              (string)userEnteredParameters[1],
                                                              (string)userEnteredParameters[2],
                                                              (Motorcycle.eMotorCycleLicenseType)userEnteredParameters[3],
               ...
               /* case Vehicle.eTypeOfVehicle.GasTruck:
                    userEnteredParameters = getParametersFromUser(GasolineTruck.GetRequiredParameters());
                    createdVehicleData = new GasolineTruck(
                                                         (string)userEnteredParameters[0],
                                                         (string)userEnteredParameters[1],
                                                         (string)userEnteredParameters[2],
            ...
            createdVehicle = VehicleCreator.CreateVehicle(typeOfVehicleToAdd, createdVehicleData);
